  ...
  return (
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-2">
        {back && (
          <button onClick={() => navigate(-1)} aria-label="Back" className="text-slate-400">
            <ChevronLeft size={20} />
          </button>
        )}
        <div>
...
export function fmtMoney(amount: number | null | undefined, currency?: string | null) {
...
export function StatusBadge({ status }: { status: string }) {
  const map: Record<string, "blue" | "green" | "red" | "amber" | "slate"> = {
    pending: "amber", completed: "green", confirmed: "green", failed: "red", rejected: "red", cancelled: "slate",
  };
